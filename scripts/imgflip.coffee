...
#   hubot <text> but that's none of my business - But That's None of My Business
#   hubot do you want to <text> because that's how you <text> - Archer
#   hubot <text> and at this point I'm afraid to ask - Andy Dwyer
#   hubot <text> you da real MVP
#
# Author:
